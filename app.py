...
CLUES = [
    ...
    {'id': 'loc_19', 'name': 'School of Agriculture', 'question': 'Where the seeds of tomorrow are planted and studied.', 'answer': 'agriculture', 'hint': 'Look for the green thumb building.', 'image': 'agriculture_block.png', 'lat': 31.2455, 'lng': 75.7015},
]
